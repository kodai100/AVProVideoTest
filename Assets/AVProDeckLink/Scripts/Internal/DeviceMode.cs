...
namespace RenderHeads.Media.AVProDeckLink
{
	public class DeviceMode
	{
		...
		private bool _supportsKeying;

		public enum FieldMode : int
		{
			Progressive,
		...
		public bool SupportKeying
		{
			get { return _supportsKeying; }
		}

		public DeviceMode(Device device, int modeIndex, int width, int height, float frameRate, long frameDuration, FieldMode fieldMode, string modeDesc, string pixelFormatDesc, bool supportsStereo3D, bool supportsKeying)
		{
			_device = device;
			...
			_supportsKeying = supportsKeying;
